...
export default function UploadHarini() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center font-sans px-4 py-12 relative">
      ...
      <h1 className="text-4xl sm:text-6xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600 drop-shadow-2xl mb-16">
        Upload Image to Harini Folder 📸
      </h1>
      ...
      <form onSubmit={handleFileUpload} className="flex flex-col items-center space-y-6 w-full max-w-2xl">
        ...
        <button
          ...
          disabled={uploading}
        >
          {uploading ? 'Uploading... ' : 'Upload to Harini Folder'}
        </button>
      </form>
      ...
      {uploadUrl && (
        <div className="mt-6 flex flex-col items-center justify-center text-center text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600">
