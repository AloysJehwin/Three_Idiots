...
export default function UploadJeslin() {
  ...
  const handleFileUpload = async (e: React.FormEvent) => {
    ...
    formData.append('folder', 'jeslin_rindhiya');
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center font-sans px-4 py-12 relative">
      ...
      <h1 className="text-4xl sm:text-6xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-pink-600 drop-shadow-2xl mb-16">
        Upload Image to Jeslin Folder 📸
      </h1>
      ...
      <form onSubmit={handleFileUpload} className="flex flex-col items-center space-y-6 w-full max-w-2xl">
        ...
        <button
          type="submit"
          className="bg-gradient-to-r from-yellow-400 to-pink-600 text-white px-8 py-3 text-xl rounded-lg w-64 hover:scale-105 transition-transform duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          disabled={uploading}
        >
          {uploading ? 'Uploading... ' : 'Upload to Jeslin Folder'}
        </button>
      </form>
      ...
      {uploading && (
        <div className="mt-6 w-full text-center max-w-2xl">
          ...
          <div className="h-2 w-full bg-gray-300 mt-2 rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-yellow-400 to-pink-600 transition-all duration-300"
      ...
      {uploadUrl && (
        <div className="mt-6 flex flex-col items-center justify-center text-center text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-pink-600">
      ...
      <div className="mt-16 max-w-3xl mx-auto bg-gray-800 p-8 rounded-xl shadow-lg space-y-6">
        <h2 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-pink-600">
