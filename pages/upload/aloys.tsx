...
export default function UploadAloys() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center font-sans px-4 py-12 relative">
      ...
      <h1 className="text-4xl sm:text-6xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-600 drop-shadow-2xl mb-16">
        Upload Image to Aloys Folder 📸
      </h1>
      ...
      {uploadUrl && (
        <div className="mt-6 flex flex-col items-center justify-center text-center text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-600">
